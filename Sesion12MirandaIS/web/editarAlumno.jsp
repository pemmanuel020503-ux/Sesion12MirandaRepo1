<%-- 
    ...
    Created on : 4/11/2025, 08:26:14 AM
    Author     : pemma
--%>

<html>
    <head>
        <title>Pagina Editar Usuario Miranda Aplicacion WEB JSP </title>
        <meta charset="UTF-8">
            ...
            <div class="row">
                ...
                <div class="col-md-4 order-details">
                    <div class="section-title text-center">
                        ...
                        <br>
                        <h3 class="title">Editar Alumno Miranda</h3>
                    </div>
...
<!-- /SECTION -->
   ...
   ps =conexion.prepareStatement("update tususarios set usuario='" + usuario + "', password='" + password + "' where id_usuario='"+id_usuario+"';");
                         ps.executeUpdate();

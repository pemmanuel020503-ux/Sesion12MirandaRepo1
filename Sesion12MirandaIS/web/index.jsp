<%-- 
    Document   : index
    Created on : 30/10/2025, 08:10:47 AM
    Author     : pemma
--%>

<html>
    <head>
        <title>Pagina principal  Miranda Aplicacion WEB </title>
        <meta charset="UTF-8">
...
<br>
        <div class="container">
            <center>
                ...
                <h4>LISTA OFICIAL DE USARIOS DE SISTEMA MIRANDA</h4>
                <br>
            </center>  
                ...
                <table class="table table-striped table-bordered table-hover" style="text-align: center">
                    ...
                    <tbody>
                        ...
                        <%
                          st=conexion.prepareStatement("select * from tususarios");
                          rs=st.executeQuery();
